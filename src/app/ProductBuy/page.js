...
export default function Iphone14ProPage() {
  return (
    <div className="bg-white">
      ...
      {/* Breadcrumb */}
      <div className="max-w-7xl mx-auto px-4 text-xs sm:text-sm text-gray-500 py-3">
      ...
      <div className="max-w-7xl mx-auto px-4 py-4 grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-7 space-y-4">
          <h1 className="text-xl sm:text-2xl font-bold">iPhone 14 Pro</h1>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                min={1}
                defaultValue={1}
                className="border px-3 py-1 rounded w-full sm:w-24 mt-1"
              />
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 mt-4">
            <button className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white py-2 px-6 rounded shadow">
              Buy Now
            </button>
            <button className="w-full sm:w-auto bg-gray-200 text-black py-2 px-6 rounded hover:bg-gray-300">
              Add to Cart
            </button>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <div className="md:col-span-8">
          <div className="border-b flex gap-6 text-sm font-medium overflow-x-auto">
          ...
          <div className="py-4 text-sm text-gray-700">
            <p>
              The iPhone 14 Pro features a stunning 6.1-inch Super Retina XDR display, powered by the new A16 Bionic chip.
              Capture life’s moments with a pro camera system featuring a 48MP main lens, and enjoy lightning-fast 5G connectivity.
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={i} className="border p-2 rounded text-sm text-center hover:shadow">
              <img src={item.img} className="h-24 mx-auto mb-2 object-contain max-w-full" />
              <p>{item.title}</p>
