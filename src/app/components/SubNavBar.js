...
export default function SubNavBar() {
  return (
    <div className="bg-white  px-4 py-2 flex justify-between items-center text-sm text-gray-700">
      
      {/* Left Links */}
      <div className="flex gap-4 items-center">
        <Link href="/ProductDetails" > <button className="hover:text-blue-600 font-medium">All category</button>
        </Link>
