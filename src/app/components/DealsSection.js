...
export default function DealsSection(){
    ...
    return(
        <div className="bg-white rounded shadow grid md:grid-cols-6 overflow-hidden p-4 my-6">
            <div className="col-span-1 p-4 ">
               ...
               <div key={idx} className="bg-gray-800 text-white px-2 py-1 rounded text-xs">
            ...
            {deals.map((item , index) =>(
                <div key={index} className="col-span-1 flex flex-col items-center justify-center p-4 border-2 border-white last:border-none">
                    ...
                    <span className="text-red-500 text-xs font-bold mt-1">{item.discount}</span>
               </div>
            ))}
